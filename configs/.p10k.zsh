# Generated by Powerlevel10k configuration wizard on 2024-10-04 at 11:23 WIB.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 04242.
# Wizard options: powerline, ascii, lean, 12h time, 1 line, sparse, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%f'     # default foreground
      local      clean='%123F'   # green foreground
      local   modified='%123F'  # yellow foreground
      local  untracked='%123F'   # blue foreground
      local conflicted='%123F'  # red foreground
    else
